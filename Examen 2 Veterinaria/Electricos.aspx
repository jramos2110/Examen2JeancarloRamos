<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Electricos.aspx.cs" Inherits="Examen_2_Veterinaria.Electricos" %>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
		            ...
		            <div class="form-group">
							...
							<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:EXAMEN2DBConnectionString3 %>" SelectCommand="SELECT * FROM [electricidad]" InsertCommand="INSERT INTO electricidad (Nombre,Telefono,Direccion,Cedula,Monto,Descuento,Subtotal,Iva,Total) VALUES (@Nombre,@Telefono,@Direccion,@Cedula,@Monto,@Descuento,@Subtotal,@Iva,@Total)">
                                <InsertParameters>
                                    ...
                                    <asp:ControlParameter ControlID="Ldescuentoss" Name="Descuento" PropertyName="Text" />
